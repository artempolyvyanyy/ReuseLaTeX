...
\chat{Artem}{To accomplish this task, read~\cite{DBLP:books/sp/22/P2022}.}
\chat{Author}{Thanks, I will do that!}
\done{Author}{Briefly discuss the research area of process mining.}

Use the \change{from}{to} command (see \texttt{core.config.txt}) to track changes, where ``from'' is the old text and ``to'' is the new text. Uncomment one of the three versions of the command to suit your purpose.
